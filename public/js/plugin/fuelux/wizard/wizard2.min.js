var old = $.fn.wizard,
    Wizard = function(a, b) {
        ...
        this.$nextBtn = this.$element.find("button.btn-next"), c = this.$nextBtn.children().detach(),
        ...
        this.options.disablePreviousStep && (this.$prevBtn.attr("disabled", !0),
...
Wizard.prototype = {
    ...
    "setState": function() {
        ...
        var l = k.data().target;
        this.$element.next(".step-content").find(".step-pane").removeClass("active"), $(l).addClass("active"),
