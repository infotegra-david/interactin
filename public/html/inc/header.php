...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	class="fixed-ribbon  desktop-detected  fixed-header fixed-navigation    pace-done smart-style-5"
				...
				<header id="header">
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="../logout" title="Cerrar sesión" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
