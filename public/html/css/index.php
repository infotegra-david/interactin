		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
				...
				<div class="hero">
					...
					<img src="<?php echo ASSETS_URL; ?>/img/demo/estudiantes.jpg" class="pull-right display-image" alt="" style="width:280px">
							...
							<?php
								...
								$accordion->content('panel2', 
									'<p class="form-group">
										...
										<br>
										<br>
										También permite crear los convenios (automáticamente) para llevar un registro en la plataforma de los convenios a suscribir, 
										el módulo cuenta con un generador de documentos constitutivos a manera de preforma jurídica, facilitando y optimizando el tiempo de la elaboración 
										y administración de convenios. 
									</p>
