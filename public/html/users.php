...
$page_nav["InterAdmin"]["sub"]["Settings"]["sub"]["UserSettings"]["active"] = true;
include("inc/nav.php");
...
<!-- ==========================CONTENT STARTS HERE ========================== -->
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>InterAdmin</li><li>Ajustes</li><li>Usuarios</li>
				</ol>
				<!-- end breadcrumb -->
									...
									<div class="widget-body no-padding">
										...
										<table id="example" class="display projects-table table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									        <thead>
									            <tr>
									                <th></th><th>Usuario</th>
									                <th><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Tareas</th>
									                <th>Revisores</th>
									                <th>Archivo</th>
