...
@section('content')
    ...
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
				...
				<fieldset>
					<section class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
						<label class="input control-label"> <i class="icon-append fa fa-user"></i>
							...
							<b class="tooltip tooltip-bottom-right">Necesario para ingresar a InterActin</b> </label>
        ...
        <p class="note text-center">*El registro gratuito termina en October 2017.</p>
	</div>
