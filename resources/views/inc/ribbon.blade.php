	<!-- RIBBON -->
	<div id="ribbon"> 
		<span id="hide-menu" class="ribbon-button-alignment">
			<span class="btn btn-ribbon"> <a href="javascript:void(0);" title="Collapse Menu" data-action="toggleMenu"><i class="fa fa-reorder"></i></a> </span>
		</span>
