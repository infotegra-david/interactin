...
@section('content')
	<div id="content_editor" class="container">
		<div id="content_columns" class="text-left">
			...
			<div class="columns">
				<textarea name="editor1" col="10" row="6" class="hide">
...
@section('scripts')
	...
	{{-- Html::script('/js/plugin/ckeditor_3/ckeditor.js') --}}
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			CKEDITOR.replace( 'editor1', {
			    extraPlugins: 'colordialog,tableresize,uploadimage,uploadfile'
			 } );
