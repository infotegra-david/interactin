                ...
                <div class="widget-body">
                  ...
                  <div class="row">
                        ...
                        <?php 
                         ...
                         @if(Route::current()->getName() == 'interout.edit')
                        <?php 
                            $route = ['interchanges.interout.update', $interchange['interchangeId']];
                         ?>
                         @elseif(Route::current()->getName() == 'interin.edit')
                        <?php 
                            $route = ['interchanges.interin.update', $interchange['interchangeId']];
                         ?>                                             
                         @endif
                          @include('interchanges.fields_preregistro')
                ...
                <div class="widget-body">
                  ...
                  <div class="row">
                      ...
                      <?php 
                       ...
                       @if(Route::current()->getName() == 'interchanges.interout.edit')
                      <?php 
                          $route = ['interchanges.interout.update', $interchange['interchangeId']];
                       ?>
                       @elseif(Route::current()->getName() == 'interchanges.interin.edit')
                      <?php 
                          $route = ['interchanges.interin.update', $interchange['interchangeId']];
                       ?>                                             
                       @endif
                        @include('interchanges.fields_registro')
