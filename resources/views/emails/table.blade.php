<br>
    <h3>Para administrar los emails seleccione un filtro</h3>
 ...
 -->
            ...
            @foreach($emails as $email)
                <tr>
                    ...
                    <td>{!! $email->estado !!}</td>
                    <td>
                        {!! Form::open(['route' => [$route_split.'.destroy', $email->id], 'method' => 'delete']) !!}
                        <div class='btn-group'>
                            <a href="{!! route($route_split.'.show', [$email->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                            <a href="{!! route($route_split.'.edit', [$email->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
