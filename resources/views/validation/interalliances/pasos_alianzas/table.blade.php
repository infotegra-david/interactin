<table class="table table-responsive" id="pasosAlianzas-table">
    ...
    @foreach($pasosAlianzas as $pasosAlianza)
        <tr>
            ...
            <td>
                <div class='btn-group'>
                    <a href="{!! route('interalliances.validations_interalliances.show', [$pasosAlianza->alianza_id]) !!}" class='btn btn-default btn-xs' title='Ver registro'><i class="glyphicon glyphicon-eye-open"></i></a>
                </div>
            </td>
        </tr>
    @endforeach
